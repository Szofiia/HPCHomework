...
int main(int argc, char** argv)
{
    ...
    std::cout << "Cuda HostAPI time difference = " << std::chrono::duration_cast<std::chrono::microseconds>(end - begin).count() << "[µs]" << std::endl;
    ...
    std::cout << "Cuda DevAPI time difference = " << std::chrono::duration_cast<std::chrono::microseconds>(end - begin).count() << "[µs]" << std::endl;
